...
public class DBHelper
{
	...
	static final String colPName="ParentName";
	static final String colPPhoneNum="PphoneNum";
	 ...
	 */
	public long insertParent(String email, String username, String password, String phoneNum)
	{
		ContentValues initialValues = new ContentValues();  
		initialValues.put(colEmail, email); 
        initialValues.put(colPName, username);  
	...
	public long insertChild(String username, String password, String age, String phoneNum, Integer IDparent)
	{
		ContentValues initialValues = new ContentValues(); 
		initialValues.put(colChildName, username);
		initialValues.put(colChildPassword, password);
		initialValues.put(colChildAge, age);
		initialValues.put(colPPhoneNum, phoneNum);
		initialValues.put(colIDParent, IDparent);
	 ...
	 * @return
	 */
	public long insertPrescription(String medName, Integer medAmount, Integer medDosage, Integer duration, String description, Integer IDChild)
	{
		ContentValues initialValues = new ContentValues(); 
	...
	public Cursor fetchAllChilds() {
        return db.query(childTable, new String[] {colChildID, colChildName, colChildAge,
        		colCPhoneNum, colChildPassword, colRewardPoint}, null, null, null, null, null);
		//return null;
    }
